...
function addProduct(e) {
  ...
  //  add new product to the products
...
function renderAllProducts() {
  // Check if there is no products => return
  ...
  //   Calling events function for the rendered remove buttons
  createEventsRemoveBtns();
  createEventsQuantityBtns();
}
...
function createEventsRemoveBtns() {
  console.log("Attach event listners");
...
function updateTotal(amount) {
  // Update the qty (amount ) value in the products array
  ...
  // Update the product total in DOM
